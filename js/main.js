...
$(document).ready(function() {
    ...
    $('.main-slider .owl-carousel').owlCarousel({
        ...
        rtl: true,
        margin: 20,
        navText: ["<span class='fas fa-caret-right'></span>", "<span class='fas fa-caret-left'></span>"],
    ...
    $('.photography .owl-carousel').owlCarousel({
        loop: true,
        autoplay: true,
        autoplayTimeout: 4000,
        margin: 0,
    ...
    if ($(window).width() <= 991) {
        $(".contact-us .contact-box").addClass("owl-carousel owl-theme");
        $(".contact-box .contact").removeClass("owl-carousel");
        $('.contact-us .owl-carousel').owlCarousel({
            loop: false,
            margin: 20,
            rtl: true,
            responsiveClass: true,
        ...
        $(".contact-us .contact-box").removeClass("owl-carousel");
        $(".contact-box .contact").removeClass("owl-carousel");
    };
